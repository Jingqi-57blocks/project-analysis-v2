...
- `module-detail:$module` — the module, the capabilities it serves, its endpoints, the parts it spans, and what grouped it
- `module-flows:$module` — the request paths through it, hop by hop, with the tables each reaches
